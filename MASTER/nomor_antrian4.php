...
<center>Poli Spesialis Dalam</center>

<div class="queue">
    <span class="prefix" id="pref">D</span><span class="number" id="num">001</span>
</div>
...
<script>
    ...
    document.getElementById('activateSound').addEventListener('click', function(){
        ...
        speakCode(letters[idx], cnt);     // ucapkan kode pertama otomatis (D satu)
    });
