...
<head>
    ...
    <meta http-equiv="refresh" content="240;url=panggil_pasien.php">
 <style>
body {
    margin:0;
...
<body>
    ...
    if ($result->num_rows > 0) {
        ...
        echo "<a href='http://10.10.20.250/dashboard/APPS-ROBOT/TV/panggil_pasien2.php' target='_blank' class='btn'>Antrian Pasien Lengkap</a>";
        echo "</form>";
        echo "</div>";
