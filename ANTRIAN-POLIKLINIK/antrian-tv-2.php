...
<div align="left">
	...
	<noscript>
     ...
     <?php
        ...
        if (isset($token["kd_poli"])) {
            ...
            exit(header("Location: http://10.10.20.250/dashboard/APPS-ROBOT/ANTRIAN-POLIKLINIK/antrian-tv-2.php"));
        }
    ...
    <table border='0' witdh='100%' cellpadding='0' cellspacing='0'>
        <tr class='head2' border='0'>
            <td width='35%' align='center'><font size='3' color='#DD0000'><b>Panggilan Untuk</b></font></td><td><font size='6' color='#DD0000'><b>:</b></font></td>
            <td width='64%' align='center'>
            <?php 
                $_sql="select * from antripoli where antripoli.kd_poli='".$kd_poli."' and antripoli.kd_dokter='".$kd_dokter."'" ;  
                $hasil=bukaquery($_sql);
                while ($data = mysqli_fetch_array ($hasil)){
                    echo "<font size='2' color='#DD0000'><b>".getOne("select concat(reg_periksa.no_reg,' ',reg_periksa.no_rawat,' ',pasien.nm_pasien) from reg_periksa inner join pasien on reg_periksa.no_rkm_medis=pasien.no_rkm_medis where reg_periksa.no_rawat='".$data['no_rawat']."'")."</b></font>";
                    if($data['status']=="1"){
    ...
    <table width='100%' bgcolor='FFFFFF' border='0' align='center' cellpadding='0' cellspacing='0'>
        <tr class='head4'>
          <td width='10%'><div align='center'><font size='2'><b>NO</b></font></div></td>
          <td width='25%'><div align='center'><font size='2'><b>NO.RAWAT</b></font></div></td>
          <td width='65%'><div align='center'><font size='2'><b>NAMA PASIEN</b></font></div></td>
        </tr>
        <?php  
