...
<meta http-equiv="refresh" content="4;url=poli.php"> 
...
<div align="left">
	...
	<noscript>
     ...
     <?php
        ...
        if (isset($token["kd_poli"])) {
            ...
            exit(header("Location: http://10.10.20.252/webapps/antrian.php"));
        }
        ...
        echo "   
           <br> 
                                  <center><font size='5' color='green' face='Tahoma' >Antrian Poliklinik : ".getOne("select nm_poli from poliklinik where kd_poli='".$kd_poli."'").".<br> Dokter Poliklinik    : ".getOne("select nm_dokter from dokter where kd_dokter='".$kd_dokter."'").".<br> Tanggal : ".date("d-M-Y", $tanggal)." Waktu : ". $jam."</font>
                                  <br><br>
                           </center>
                        </td>   
    ...
    <table border='0' witdh='100%' cellpadding='0' cellspacing='0'>
        <tr class='head2' border='0'>
            <td width='35%' align='center'><font size='6' color='#DD0000'><b>Panggilan Untuk</b></font></td><td><font size='6' color='#DD0000'><b>:</b></font></td>
